...
//Lottie permite usar animações usar animações JSON criadas no After Effects/Figma
        ...
        <View style={{height: size, aspectRatio: 1}}>
            {/*
                Componente LottieView que exibe a animação
                    style ={{flex:1}} faz com que a animação ocupe todo o espaço disponível no container source carrega o arquivo JSON da animação da pasta assets/images
